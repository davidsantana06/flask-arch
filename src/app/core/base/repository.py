...
class Repository():
    ...
    def _find_by(self, model_cls: Model, filters: Tuple[ColumnElement[bool]]) -> Model:
    ...
    def _find_all_by(self, model_cls: Model, filters: Tuple[ColumnElement[bool]]) -> List[Model]:
